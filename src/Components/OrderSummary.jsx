...
const OrderSummary = ({ totalPrice, valid, handleRun }) => {
    ...
    return (
        <>
            <div className="md-mx:w-[95%] text-sm mx-auto w-[35%]">
                <div className="flex flex-col gap-4 h-fit py-3 px-5 m-2 border-[1px] border-gray-300 rounded-lg">
                    ...
                    {show === 1 && (
                        <div className="animate-[wiggle_0.7s_ease-in-out_1]">
                            <FloatingInput id="upi" name="UPI Id" value={formData.upi} handleChange={handleChange} errorMessage={formError.upi} />
                        </div>
                    )}
                    {show === 2 && (
